...
lenguaje de *marcado ligero* que permite dar formato a textos planos **utilizando símbolos** y caracteres especiales de forma ***rápida y sencilla***.

~~Introducción a sistemas~~
---
# Experiencia de estar en ingeniería de sistemas
--- 
Ha sido muy interesante tener la oportunidad de conocer poco a poco las habilidades que debe 
tener un ingeniero, por lo que hemos desarrollado un poco la lógica y esto nos ha permitido 
saber desenvolvernos en la resolución de distintos problemas. 

---
[Ingeniero de sistemas](https://i.pinimg.com/736x/14/20/fd/1420fdb2c1b84a55bc9a61e3050b0fa5.jpg)
---
- # Qué son licencias de código? 
---
Las licencias de software son reglas que indican qué pueden hacer otras personas con un programa y su código. Permiten establecer si pueden usarlo, modificarlo, copiarlo o compartirlo y bajo qué condiciones.

---
- # ¿Cúal es la utilidad de estas licencias? 
Sirven para proteger los derechos del creador y, al mismo tiempo, dejar claros los permisos que tiene cualquier persona que quiera utilizar el software.
